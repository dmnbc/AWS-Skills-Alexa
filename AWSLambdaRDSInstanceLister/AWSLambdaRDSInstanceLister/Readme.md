...
```
    cd "AWSLambdaRDSInstanceLister"
    dotnet restore
```

Execute unit tests
```
    cd "AWSLambdaRDSInstanceLister/test/AWSLambdaRDSInstanceLister.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AWSLambdaRDSInstanceLister/src/AWSLambdaRDSInstanceLister"
